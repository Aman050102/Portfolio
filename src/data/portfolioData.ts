...
export const projects: Project[] = [
  {
    ...
    description:
      "Automated GPA calculation tracking system. Utilizing Robot Framework to validate calculation logic accuracy and end-to-end data integrity via browser automation.",
  ...
  },
  {
    ...
    description:
      "API testing implementation and automation script creation to validate response statuses, schemas, and payload data, ensuring robust backend quality assurance.",
    link: "#",
    type: "Automation",
  ...
  },
  {
    ...
    description:
      "Designed comprehensive test cases, execution scenarios, and bug reporting flows for a shopping cart system, covering both positive and negative testing vectors.",
    link: "#",
    type: "Manual",
