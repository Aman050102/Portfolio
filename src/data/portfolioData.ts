export interface Project {
  ...
  productionLink?: string; // ลิงก์ไปยังหน้าโปรเจกต์จริง (ถ้ามี)
}
...
export const projects: Project[] = [
  {
    ...
    description:
      "Validates Microsoft SSO integration, including Positive/Negative login cases and Multi-Factor Authentication (MFA) approval.",
    type: "Automation",
    tags: ["Robot Framework", "Selenium", "E2E Testing", "Dialogs"],
    testCaseLink:
      "https://docs.google.com/spreadsheets/d/18X8hNndFs7OYBJRG1Q1WZmRr457E2QPYohVV3G75sU0/edit?usp=sharing",
  ...
  },
  {
    ...
    systemName: "UP REG - Academic Tracking System",
    description:
      "Verifies the GPA calculation engine across various boundary values (Max GPA, Min GPA, and Mixed Grade distributions).",
    type: "Automation",
    tags: ["Robot Framework", "Selenium", "Collections", "Data Integrity"],
    testCaseLink:
      "https://docs.google.com/spreadsheets/d/1PI5PB_qJK06HG-TZDDuOzKIEWRTdMhn-X37I489Y1M8/edit?usp=sharing",
...

  {
    ...
    description:
      "Analyzed Figma UI/UX wireframes and user flows to design comprehensive manual functional test cases for the salon back-office admin dashboard. Focused on validating transaction logic for booking distribution, status transitions, and layout conformity against design specifications.",
    type: "Manual",
    tags: ["Manual Testing", "UI/UX", "Figma", "Test Case Design"],
    testCaseLink:
      "https://docs.google.com/spreadsheets/d/1067UhR6k_uH7_LH7gSv303TsIluVToiYk4QLqLNUC90/edit?usp=sharing",
  },
  {
    title: "Equipment Inventory Tracking",
    systemName: "Salon Booking Web App",
    description:
      "Executed black-box user acceptance testing (UAT) for real-time sports gear stock management.",
    type: "Manual",
  ...
  },
  {
    ...
    description:
      "Verified calendar slot conflicts, reservation overlaps, and edge-case boundary testing vectors.",
    type: "Manual",
  ...
  },
  {
    ...
    description:
      "uses AI and computer vision to detect human falls in real-time. It sends immediate alerts to caregivers to ensure quick assistance for high-risk individuals.",
    type: "Development",
  ...
  },
  {
    ...
    systemName: "Web App",
    description:
      "UP-SFMS is a digital platform for University of Phayao sports facilities that streamlines usage tracking and equipment management. It enables student assistants to record data easily while providing admins with real-time analytics and automated PDF/CSV reporting.",
    type: "Development",
  ...
  },
  {
    ...
    systemName: "Web App",
    description:
      "A personal finance web application designed to help users efficiently track, manage, and optimize their daily expenses. The platform offers intuitive tools for income and expense logging, budget planning, and financial goal tracking, making money management simple and accessible for everyone.",
    type: "Development",
    tags: ["HTML", "CSS", "JavaScript"],
